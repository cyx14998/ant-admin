...
/* 提示框 */
function createBlockDialog(content, timeout, modal, isconfirm) {
    $.blockUI({
        message: content,
        fadeIn: 200,
        fadeOut: 200,
        ...
        css: {
            ...
            cursor: '',
            'font-size': '16px',
            background: isconfirm ? "url('/games/util/confirm_bg.png') no-repeat" : "url('/games/util/dialog_bg.png') no-repeat",
