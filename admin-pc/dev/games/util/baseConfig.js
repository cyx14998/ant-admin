...
function initGames() {
    ...
    $.ajax({
        ...
        data: param,
        beforeSend: function () {
            createBlockDialog("<div class='confirm' ontouchend = '$.unblockUI()'><p>加载中...</p></div>", '', true, true);
        },
        success: function (data) {
            console.log(data);
            if (data && data != 'null' && data != '[object Object]') {
                $.unblockUI();
                    ...
                    success: function (data) {
                        if (data && data.result) {
                            ...
                            if (WeiAppConfig.warninghtml && WeiAppConfig.StatusCode != 1) {
                                ...
                                var res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>" + WeiAppConfig.warninghtml + "</p></div>";
                ...
                var res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>加载失败......</p></div>";
                createBlockDialog(res_content, '', true);
            }
        },
        error: function () {
            $.unblockUI();
...
function submitGameResult(reward_code) {
    $.ajax({
        ...
        success: function (data) {
            if (data && data.result) {
                var obj = data;
                //  var content = "<div ontouchend = '$.unblockUI()'><p>" + tip_info + "</p></div>";
                ...
                var res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>" + obj.result + "</p></div>";
                var message_code = obj.code;
                if (message_code == "1") {
                    res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>" + obj.result + "</p></div>";
                }
                else if (message_code == "002") {
                    res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>非活动时间</p></div>";
                }
                else if (message_code == "006") {
                    res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>请到菜单页注册会员或继续试玩</p></div>";
                }
                else {
                    res_content = "<div class='default' ontouchend = '$.unblockUI()'><p>" + obj.result + "</p></div>";
                }
