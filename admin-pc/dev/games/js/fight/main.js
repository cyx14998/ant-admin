...
function oddbullet(X, Y) {
    ...
    bullet.call(this, X, Y, 6, 14, "/games/img/fight/bullet1.png");
...
function ourplan(X, Y) {
    ...
    var imagesrc = "/games/img/fight/my_plane.png";

    plan.call(this, 1, X, Y, 80, 67, 0, 660, 0, "/games/img/fight/plane_boom.gif", imagesrc);
...
function start() {
    ...
    if (mark == 20) {
        ...
        if (mark1 % 5 == 0) {
            ...
            enemys.push(new enemy(6, 25, 274, 75, 49, 5000, 360, random(1, 3), "/games/img/fight/md_boom.gif", "/games/img/fight/enemy3_fly_1.png"));
        ...
        //     enemys.push(new enemy(12, 57, 274, 75, 163, 30000, 540, 1, "/games/img/fight/big_boom.gif", "/games/img/fight/enemy2_fly_1.png"));
        ...
        //小飞机
            ...
            enemys.push(new enemy(1, 19, 286, 38, 24, 1000, 360, random(1, 4), "/games/img/fight/small_boom.gif", "/games/img/fight/enemy1_fly_1.png"));
            ...
            if (enemys[j].planisdie == false) {
                ...
                if (enemys[j].imagenode.offsetLeft + enemys[j].plansizeX >= selfplan.imagenode.offsetLeft && enemys[j].imagenode.offsetLeft <= selfplan.imagenode.offsetLeft + selfplan.plansizeX) {
                    ...
                    if (enemys[j].imagenode.offsetTop + enemys[j].plansizeY >= selfplan.imagenode.offsetTop + 40 && enemys[j].imagenode.offsetTop <= selfplan.imagenode.offsetTop - 20 + selfplan.plansizeY) {
                        ...
                        selfplan.imagenode.src = "/games/img/fight/plane_boom.gif";
