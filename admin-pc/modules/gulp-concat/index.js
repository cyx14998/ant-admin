...
module.exports = function(file, opt) {
    ...
    function endStream(cb) {
        ...
        if (typeof file === 'string') {
            ...
            if (file.newpath) {
                joinedFile.path = path.join(latestFile.base, file.path);
            } else {
                // by stone       
                joinedFile.base = latestFile.base;
                joinedFile.path = path.join(path.dirname(latestFile.path), file.path);
            }
            // console.log("path:" + joinedFile.path);
        }    
