...
class SearchCustomer extends React.Component {
    ...
    getData(keyword) {
        ...
        tuCustomerList(params).then(res => {
            ...
            if (res.data.result !== 'success') {
                Toast.info(res.data.info || '没有查询到该企业信息', 1, null, false);
                return;
            }
            ...
            if (length == 0) {
                Toast.info('没有查询到该企业信息', 1, null, false);
                this.setState({
                    data: [],
        ...
        }).catch(err => Toast.info('没有查询到该企业信息', 1, null, false));
    }
    ...
    // 去客户详情页
    goDetails(obj) {
        window.location.href = 'customerEdit.html?tableId=' + obj.tableId;
    }
}
